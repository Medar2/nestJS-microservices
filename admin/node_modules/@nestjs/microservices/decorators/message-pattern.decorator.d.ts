...
export declare const MessagePattern: {
    ...
    <T = PatternMetadata | string>(metadata?: T, transport?: Transport): MethodDecorator;
    <T = PatternMetadata | string>(metadata?: T, extras?: Record<string, any>): MethodDecorator;
    <T = PatternMetadata | string>(metadata?: T, transport?: Transport, extras?: Record<string, any>): MethodDecorator;
};
/**
